...
<xsl:stylesheet
    ...
    <xsl:template match="tei:person">
        ...
        <div class="modal fade" id="{@xml:id}" data-bs-keyboard="false" tabindex="-1" aria-labelledby="{concat(string-join(./tei:persName/tei:surname), ', ', string-join(./tei:persName/tei:forename))}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel"><xsl:value-of select="concat(string-join(./tei:persName/tei:surname), ', ', string-join(./tei:persName/tei:forename))"/></h1>
